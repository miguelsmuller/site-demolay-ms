    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <section class="col-sm-12 col-md-8">
                <header>
                    <?php $term = get_term_by( 'slug', get_query_var( 'term' ), 'arquivos-categoria' ); ?>
                    <h1>Biblioteca - Categoria "<?php echo $term->name ?>"</h1>
                </header>

                
                <?php
            $termchildren = get_term_children( $term->term_id, 'arquivos-categoria' );
